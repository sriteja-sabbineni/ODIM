...
func Router() *iris.Application {
	...
	chassis.Get("/{id}/PCIeDevices/{rid}/PCIeFunctions/{rid}", cha.GetChassisResource)
	chassis.Any("/{id}/PCIeDevices/{rid}/PCIeFunctions/{rid}", handle.ChassisMethodNotAllowed)
